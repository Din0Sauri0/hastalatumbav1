var questions = [
	{question:"Cuál será tu Pseudónimo?"},
	{question:"Cuál Es Tú Género"},
	{question:"Cuál Es Tú Email", pattern: /^[^\s@]+@[^\s@]+\.[^\s@]+$/},
	{question:"Crea Una Contraseña", type: "password"}
  ]
  ...
  ;(function(){
	...
	function done() {
	  ...
	  h1.appendChild(document.createTextNode('Bienvenido al club ' + questions[0].value + '!'))
	  setTimeout(function() {
