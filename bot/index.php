...
<body>
            ...
            <div class="card-footer">
                <form>
                    <div class="form-row align-items-center">
                        <div class="col-10">
                            <input type="text" class="form-control mb-2" id="data" placeholder="Escribe aquí..."
                                required>
                        </div>
                        <div class="col-2">
    ...
    $(document).ready(function() {
        $("#send-btn").on("click", function() {
            $valor = $("#data").val();
            $mensaje =
                '<div class="user-inbox inbox border rounded p-2"><div class="msg-header"><p class="mb-0">' +
                $valor + '</p></div></div>';
            $("#form").append($mensaje);
            $("#data").val('');
            ...
            $.ajax({
                ...
                success: function(resultado) {
                    $respuesta =
                        '<div class="bot-inbox inbox border rounded p-2"><div class="icon"><i class="fas fa-user"> Chat-GPT</i></div><div class="msg-header"><p class="mb-0">' +
                        resultado + '</p></div></div>';
