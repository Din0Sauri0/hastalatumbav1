            ...
            <div class="cs-slider_heading cs-style1">
                <div class="cs-section_heading cs-style1">
                    <h3 class="cs-section_subtitle wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s">
                        Hastalatumba Team</h3>
                    <h2 class="cs-section_title">Nuestro Equipo </h2>
                </div>
            ...
            <div class="cs-slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0"
                ...
                <div class="cs-slider_wrapper">
                    <div class="cs-slide">
                        <div class="cs-team cs-style1">
                            <div class="cs-member_thumb">
                                <img src="<?php echo $url_index ?><?php echo $imagenes_index ?>equipo/hombre.webp"
                            ...
                            <div class="cs-member_info">
                                ...
                                <div class="cs-member_designation">Visuales</div>
                            </div>
                        </div>
                    </div>
                    <div class="cs-slide">
                        <div class="cs-team cs-style1">
                            <div class="cs-member_thumb">
                                <img src="<?php echo $url_index ?><?php echo $imagenes_index ?>equipo/mujer.webp"
                                    alt="Equipo Hastalatumba" title="Team Hastalatumba">
                                <div class="cs-member_overlay"></div>
                            </div>
                            <div class="cs-member_info">
                                ...
                                <div class="cs-member_designation">Negocios</div>
                            </div>
                        </div>
                    </div>
                    <div class="cs-slide">
                        <div class="cs-team cs-style1">
                            ...
                            <div class="cs-member_info">
                                ...
                                <div class="cs-member_designation">Web&Seo</div>
                            </div>
                        </div>
                    </div>
                    <div class="cs-slide">
                        <div class="cs-team cs-style1">
                            ...
                            <div class="cs-member_info">
                                ...
                                <div class="cs-member_designation">Voces</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cs-slide">
                        <div class="cs-team cs-style1">
                            <div class="cs-member_thumb">
                                <img src="<?php echo $url_index ?><?php echo $imagenes_index ?>equipo/cris.webp"
                                    alt="Equipo Hastalatumba" title="Team Hastalatumba">
                                <div class="cs-member_overlay"></div>
                            </div>
                            <div class="cs-member_info">
                                ...
                                <div class="cs-member_designation">CEO</div>
                            </div>
                        </div>
                    </div>
                    <div class="cs-slide">
