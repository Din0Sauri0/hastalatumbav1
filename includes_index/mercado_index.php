            ...
            <div class="cs-slider_heading cs-style1">
                <div class="cs-section_heading cs-style1">
                    <h3 class="cs-section_subtitle wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s">
                        Mercado hastalatumba </h3>
                    <h2 class="cs-section_title">El Mercado</h2>
                </div>
                    ...
                    <div class="cs-slide">
                        <div class="cs-team cs-style1">
                            <div class="cs-member_thumb">
                                <img src="<?php echo $url_index ?><?php echo $imagenes_index ?>merchandising/tazon.webp"
                                    alt="Equipo Hastalatumba" title="Team Hastalatumba">
                                <div class="cs-member_overlay"></div>
                            </div>
                            <div class="cs-member_info" style="background-color:#ffffff70; font-weight:600">
                                <div class="cs-member_designation" style="color:black">Tazones</div>
                            </div>
                        </div>
                    </div>
                    <div class="cs-slide">
                        <div class="cs-team cs-style1">
                            <div class="cs-member_thumb">
                                <img src="<?php echo $url_index ?><?php echo $imagenes_index ?>merchandising/poleras.webp"
                                    alt="Equipo Hastalatumba" title="Team Hastalatumba">
                                <div class="cs-member_overlay"></div>
                            </div>
                            <div class="cs-member_info" style="background-color:#ffffff70; font-weight:600">
                                <div class="cs-member_designation" style="color:black">Poleras</div>
                            </div>
                        </div>
                    </div>
                    <div class="cs-slide">
                        <div class="cs-team cs-style1">
                            <div class="cs-member_thumb">
                                <img src="<?php echo $url_index ?><?php echo $imagenes_index ?>merchandising/mousepad.webp"
                                    alt="Equipo Hastalatumba" title="Team Hastalatumba">
                                <div class="cs-member_overlay"></div>
                            </div>
                            <div class="cs-member_info" style="background-color:#ffffff70; font-weight:600">
                                <div class="cs-member_designation" style="color:black">MousePad</div>
                            </div>
                        </div>
                    </div>
                    <div class="cs-slide">
