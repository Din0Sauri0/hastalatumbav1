    ...
    <div class="container">
        <div class="cs-section_heading cs-style1">
            <h3 class="cs-section_subtitle wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s"
                ...
                La gente opina</h3>
            <h2 class="cs-section_title">Testimonios</h2>
        </div>
                        ...
                        <div class="slider-nav_item">
                            <div class="cs-rotate_img">
                                <div class="cs-rotate_img_in">
                                    <img src="<?php echo $url_index ?><?php echo $imagenes_index ?>testimonios/testimonios.webp"
                                        alt="Testimonios de nickname" title="Testimonios de nickname">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="slider-for cs-style1">
                    <div class="slider-for_item">
                        <div class="cs-testimonial cs-style1">
                            ...
                            <div class="cs-testimonial_text"> hola</div>
                            <div class="cs-rating" data-rating="4">
                                <div class="cs-rating_bg"
                                    data-src="<?php echo $url_index ?><?php echo $imagenes_index ?>rating/rating.svg">
                                </div>
                                <div class="cs-rating_percentage"
                                    data-src="<?php echo $url_index ?><?php echo $imagenes_index ?>rating/rating.svg">
                                </div>
                            </div>
                            <h2 class="cs-testimonial_avatar_name">Juan Feo</h2>
