        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="main__title">
                    <h2>Administrador De Comentarios</h2>
                    ...
                    <div class="main__title-wrap">
                        ...
                        <div class="filter" id="filter__sort">
                            ...
                            <ul class="filter__item-menu dropdown-menu scrollbar-dropdown"
                                ...
                                <li data-value="date created">Ultimos</li>
                                <li data-value="estado">Estado</li>

                                <li data-value="visitas">Todos</li>
                            </ul>
                        </div>
                        <!-- end filter sort -->
                    ...
                    <table class="main__table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="main__table-text"><span class="texto-truncado">este es el ejemplo de
                                            comentsrio a moderar dependiendo de nosotros o de la ia :D :D</span></div>
                                </td>
                                <td>
                                    <div class="main__table-text main__table-text--green">APROBADO</div>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="main__table-text main__table-text--red">HATER</div>
                                </td>
                                <td>
                                    <div class="main__table-text">24-10-2023</div>
                                </td>
...
<div id="modal-view" class="zoom-anim-dialog mfp-hide modal modal--view">
    ...
    <p class="comments__text">TEXTO COMENTARIO</p>
</div>
<!-- end modal view -->
...
<div id="modal-status" class="zoom-anim-dialog mfp-hide modal">
    ...
    <p class="modal__text">Publicar Comentario??</p>
